...
pub struct PhysicsConfig {
    ...
    pub enemy_spawn_cooldown_per_stage: f32,
    pub enemy_spawn_cooldown_min: f32,
    pub enemy_max_count_base: u32,
    pub enemy_max_count_per_stage: u32,
    pub enemy_max_count_cap: u32,
    pub enemy_stage_time_secs: f32,
    pub enemy_stage_score_points: u32,
    pub enemy_spawn_radius: f32,
    pub enemy_min_player_spawn_distance: f32,
    pub enemy_min_enemy_spacing: f32,
    pub enemy_seek_force: f32,
    pub enemy_max_speed: f32,
    pub enemy_arrive_radius: f32,
    pub enemy_collider_radius: f32,
    pub enemy_linear_damping: f32,
    pub enemy_angular_damping: f32,
    pub enemy_base_hp: f32,
    pub enemy_fire_cooldown_base: f32,
    pub enemy_projectile_speed: f32,
    pub enemy_projectile_lifetime: f32,
    pub enemy_projectile_max_dist: f32,
    pub enemy_projectile_collider_radius: f32,
    pub enemy_projectile_damage: f32,
    pub enemy_damage_from_player_projectile: f32,
    pub enemy_damage_from_player_missile: f32,
    ...
    pub boss_phase_two_trigger_ratio: f32,
    pub boss_telegraph_secs: f32,
    pub boss_engage_radius: f32,
    pub boss_seek_force_mult: f32,
    pub boss_max_speed_mult: f32,
    pub boss_phase_one_fire_cooldown: f32,
    pub boss_phase_two_aim_cooldown: f32,
    pub boss_phase_two_burst_cooldown: f32,
    pub boss_phase_two_burst_shots: u32,
    ...
    pub spawn_shape_jitter_fraction_min: f32,
    pub spawn_shape_jitter_fraction_max: f32,
    pub spawn_shape_edge_subdivision_chance: f32,
    pub spawn_shape_subdivision_jitter_fraction: f32,
    pub spawn_shape_noise_frequency: f32,
    pub spawn_shape_noise_amplitude: f32,
...
impl Default for PhysicsConfig {
    fn default() -> Self {
        Self {
            ...
            enemy_spawn_cooldown_min: ENEMY_SPAWN_COOLDOWN_MIN,
            enemy_max_count_base: ENEMY_MAX_COUNT_BASE,
            enemy_max_count_per_stage: ENEMY_MAX_COUNT_PER_STAGE,
            enemy_max_count_cap: ENEMY_MAX_COUNT_CAP,
            enemy_stage_time_secs: ENEMY_STAGE_TIME_SECS,
            enemy_stage_score_points: ENEMY_STAGE_SCORE_POINTS,
            enemy_spawn_radius: ENEMY_SPAWN_RADIUS,
            enemy_min_player_spawn_distance: ENEMY_MIN_PLAYER_SPAWN_DISTANCE,
            enemy_min_enemy_spacing: ENEMY_MIN_ENEMY_SPACING,
            enemy_seek_force: ENEMY_SEEK_FORCE,
            enemy_max_speed: ENEMY_MAX_SPEED,
            enemy_arrive_radius: ENEMY_ARRIVE_RADIUS,
            enemy_collider_radius: ENEMY_COLLIDER_RADIUS,
            enemy_linear_damping: ENEMY_LINEAR_DAMPING,
            enemy_angular_damping: ENEMY_ANGULAR_DAMPING,
            enemy_base_hp: ENEMY_BASE_HP,
            enemy_fire_cooldown_base: ENEMY_FIRE_COOLDOWN_BASE,
            enemy_projectile_speed: ENEMY_PROJECTILE_SPEED,
            enemy_projectile_lifetime: ENEMY_PROJECTILE_LIFETIME,
            enemy_projectile_max_dist: ENEMY_PROJECTILE_MAX_DIST,
            enemy_projectile_collider_radius: ENEMY_PROJECTILE_COLLIDER_RADIUS,
            enemy_projectile_damage: ENEMY_PROJECTILE_DAMAGE,
            enemy_damage_from_player_projectile: ENEMY_DAMAGE_FROM_PLAYER_PROJECTILE,
            enemy_damage_from_player_missile: ENEMY_DAMAGE_FROM_PLAYER_MISSILE,
            ...
            boss_phase_two_trigger_ratio: BOSS_PHASE_TWO_TRIGGER_RATIO,
            boss_telegraph_secs: BOSS_TELEGRAPH_SECS,
            boss_engage_radius: BOSS_ENGAGE_RADIUS,
            boss_seek_force_mult: BOSS_SEEK_FORCE_MULT,
            boss_max_speed_mult: BOSS_MAX_SPEED_MULT,
            boss_phase_one_fire_cooldown: BOSS_PHASE_ONE_FIRE_COOLDOWN,
            boss_phase_two_aim_cooldown: BOSS_PHASE_TWO_AIM_COOLDOWN,
            boss_phase_two_burst_cooldown: BOSS_PHASE_TWO_BURST_COOLDOWN,
            boss_phase_two_burst_shots: BOSS_PHASE_TWO_BURST_SHOTS,
            // Player: Combat
            ...
            spawn_shape_jitter_fraction_min: SPAWN_SHAPE_JITTER_FRACTION_MIN,
            spawn_shape_jitter_fraction_max: SPAWN_SHAPE_JITTER_FRACTION_MAX,
            spawn_shape_edge_subdivision_chance: SPAWN_SHAPE_EDGE_SUBDIVISION_CHANCE,
            spawn_shape_subdivision_jitter_fraction: SPAWN_SHAPE_SUBDIVISION_JITTER_FRACTION,
            spawn_shape_noise_frequency: SPAWN_SHAPE_NOISE_FREQUENCY,
            spawn_shape_noise_amplitude: SPAWN_SHAPE_NOISE_AMPLITUDE,
